...
@Component
public class ManejadorTableroWebSocket extends TextWebSocketHandler {

    private static final Logger LOG = LoggerFactory.getLogger(ManejadorTableroWebSocket.class);
